...
Verified on 2026-08-31, the milestone tables contain 97 `DONE`, 1 `REVIEW`,
1 `SUPERSEDED`, and no `TODO`, `IN_PROGRESS`, `BLOCKED`, or `DEFERRED` tasks.
...
| RAG-SEMANTIC-001 | Replace lexical-only retrieval with evaluated pgvector hybrid retrieval | DONE | AI-006–008 | Hybrid meets the fixed retrieval floors with exactly 17 zero-retry/no-fallback requests, the complete PostgreSQL, migration, coverage, mocked/real E2E, and final fast gates pass, and independent L3 review reports no remaining P1/P2/P3. Lexical stays the default until the separate AI-008 threshold policy is approved. See `../handoffs/RAG-SEMANTIC-001.md` |
